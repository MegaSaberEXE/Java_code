    ...
    public EventObject() {
        ...
        ok.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if ( !model.isEmpty() )
                    model.clear();
                if (event.getID() == ActionEvent.ACTION_PERFORMED)model.addElement(" Event Id: ACTION_PERFORMED");
...
// press shift alt control at the same time and press ok for the modifiers
*/